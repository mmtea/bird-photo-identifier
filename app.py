                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": (
                            ...
                            "- 0-2：无任何艺术价值\n\n"
                            "**评分原则：像严厉的摄影大赛评委一样打分！**\n"
                            "- 95-100：世界级作品，国际大赛金奖水平，万里挑一\n"
                            "- 85-94：专业摄影师的优秀作品，可入选摄影展\n"
                            "- 75-84：有亮点的好照片，但至少有1-2个维度存在明显不足\n"
                            "- 60-74：普通的鸟类记录照，技术上基本合格但缺乏亮点\n"
                            "- 45-59：质量较差，有明显技术缺陷（模糊/过曝/构图差等）\n"
                            "- 30-44：质量很差，多个维度存在严重问题\n"
                            "- 30以下：几乎无法辨认的照片\n\n"
                            "**关键：大多数业余爱好者的照片应在 45-65 分之间！**\n"
                            "只有真正优秀的照片才配得上 75+ 分。\n"
                            "每个分项都要从严评判，宁可打低不要打高。\n"
                            "例如：普通的静立鸟照，清晰度最多给12-14分，构图最多10-12分，"
                            "艺术性通常只有2-4分。只有展翅/捕食等精彩瞬间才配高分。\n\n"
